...
public class TestActivity extends AppCompatActivity {
    ...
    String serverKey; //콘솔에서 받아온 서버키를 넣어줍니다
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverKey = getString(R.string.google_api_key);
    ...
    private class searchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            StoreListAdapter mAdapter = new StoreListAdapter(
                    TestActivity.this, R.layout.activity_test_listview_start, sdata); //Json파싱해서 가져온 유튜브 데이터를 이용해서 리스트를 만들어줍니다.

            searchlist.setAdapter((ListAdapter) mAdapter);
        }
    }
    ...
    public class StoreListAdapter extends ArrayAdapter<SearchData> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {// listview
            ...
            v = vi.inflate(R.layout.activity_test_listview_start, null);
            ...
            Glide.with(TestActivity.this).load(new_url).into(img);
